...
// ... (todo el código PHP de carga de $departamentos, $estados, etc. va aquí) ...
        ...
        <div class="form-columns-wrapper">
            ...
            <div class="form-column form-column-main">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-with-buttons">
                        ...
                        <div class="button-group">
                            <button type="button" id="generate-barcode-single" class="action-btn" title="Generar código EAN-13 único">Generar</button>
                            <button type="button" id="scan-barcode-add-product" class="btn btn-primary" title="Escanear código de barras">📷</button>
                        </div>
                    </div>
                ...
                <div class="form-group form-group-align-top">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="5" placeholder="Añade una descripción detallada del producto..."></textarea>
                </div>
